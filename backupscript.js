    ...
    if (isTaskAdded) {
        ...
        setTimeout(() => {
            if (TaskDescriptionBuffer.innerHTML.length >= TaskDescriptionViewer.innerHTML.length) {
                createTask(taskTitle.value, TaskDescriptionBuffer.innerHTML, taskDate.value, cardID);
            } else {
                createTask(taskTitle.value, TaskDescriptionViewer.innerHTML, taskDate.value, cardID);
            }
...
function createCard(cardTitle, cardIDRef) {
    ...
    card_Container.id = "cardContainer" + cardIDRef;
...
// Create Task
function createTask(taskTitle, taskDescription, taskDate, cardIDRef) {
